...
`c(1, 2, 3, "Hi")`
It creates a vector and stores the following values in it as characters

* Would the following be valid?

`c(1, 2, 3, "Hi") + 1 `
The following would not be valid because the contents contain different data types, so the 1 would not be able to be added

* How about 

`c(1, 2, 3, FALSE) + 1 `

#the following would be valid because the FALSE function would convert it to numeric meaning they would be the same data types#
...
(qplot(x = x_axis, y = y_axis,
      main="Maya's Plot of dots using qplot",
